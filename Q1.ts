...
let anonymousfun=function(numa,numb){
    return numa*numb
}
let result=anonymousfun(2,2)
console.log(`using anonymous function:${result}`);

function normalfun(numa,numb){
    return numa*numb
}
let result2=normalfun(2,2)
console.log(`Normal function:${result2}`);
